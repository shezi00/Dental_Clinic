...
export default function WhyChooseUs() {
  return (
    <div className="panel-wrap relative min-h-screen w-full">
      <section
        className="panel why-us relative min-h-screen w-full overflow-hidden flex flex-col justify-center bg-[#0F2E2A] text-[#FAF7F2] rounded-t-[3.5rem] sm:rounded-t-[56px] shadow-[0_-30px_60px_rgba(0,0,0,0.18)] z-[5] py-20 sm:py-24"
        data-theme="dark"
        id="why-choose-us"
      >
        <div className="panel-inner max-w-[1280px] w-full mx-auto px-[clamp(1.25rem,5vw,4rem)] grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="why-us-content space-y-6">
            ...
            <h2 className="font-serif text-[clamp(1.85rem,3.8vw,3.2rem)] leading-[1.12] text-[#FAF7F2] font-semibold">
              A modern standard for gentle, patient-centered care.
            </h2>
            <p className="text-sm sm:text-base leading-relaxed opacity-85 font-light text-[#FAF7F2]">
            ...
            <div className="space-y-4 border-t border-[rgba(250,247,242,0.15)] pt-4">
              <div className="flex items-start gap-3.5">
                ...
                <div>
                  <h4 className="font-serif font-medium text-base sm:text-lg text-[#FAF7F2]">Transparent Guidance</h4>
              ...
              <div className="flex items-start gap-3.5">
                <span className="w-2 h-2 rounded-full bg-[#FF6B4A] mt-2 shrink-0" />
                <div>
                  <h4 className="font-serif font-medium text-base sm:text-lg text-[#FAF7F2]">Minimally Invasive Tech</h4>
              ...
              <div className="flex items-start gap-3.5">
                <span className="w-2 h-2 rounded-full bg-[#FF6B4A] mt-2 shrink-0" />
                <div>
                  <h4 className="font-serif font-medium text-base sm:text-lg text-[#FAF7F2]">Comfort-First Environment</h4>
          ...
          <div className="why-us-image relative h-[300px] sm:h-[440px] w-full rounded-3xl overflow-hidden shadow-2xl border border-[rgba(250,247,242,0.15)]">
            <img
